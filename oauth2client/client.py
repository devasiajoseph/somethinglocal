...
__modfied__ = 'devasiajoseph@gmail.com (Devasia Joseph)'
...
#  Dict for oauth2 scopes
OAUTH2_SCOPE = {
    'email': 'https://www.googleapis.com/auth/userinfo.email',
    'profile': 'https://www.googleapis.com/auth/userinfo.profile',
    'adsense': 'https://www.googleapis.com/auth/adsense',
    'affiliate': 'https://www.googleapis.com/auth/gan',
    ...
    'shopping_api': 'https://www.googleapis.com/auth/structuredcontent',
    'chrome_store': 'https://www.googleapis.com/auth/chromewebstore.readonly',
    ...
    'latitude': 'https://www.googleapis.com/auth/latitude.all.city',
    'moderator': 'https://www.googleapis.com/auth/moderator',
    'alias': 'https://apps-apis.google.com/a/feeds/alias/',
    ...
    'user': 'https://apps-apis.google.com/a/feeds/user/',
...
class Credentials(object):
    ...
    JSON string as input and returns an instaniated Credentials object.
    """
    ...
    def _to_json(self, strip):
        """Utility function for creating a JSON representation of an instance
        of Credentials.
...
class OAuth2WebServerFlow(Flow):
    ...
    def __init__(self, client_id, client_secret, scope, user_agent=None,
        ...
        for each_scope in scope:
            self.scope += ' ' + OAUTH2_SCOPE[each_scope]
